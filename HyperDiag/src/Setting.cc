...
void Setting::Setting_Gene( int BatchFlag ){
	...
	float const mycol[4][3] = { { .900, .960, 1.   },
								{ 1.  , .800, .975 },
								{ .800, 1.  , .925 }, 
	                            { 1.  , 1.  , .950 } };
...
//---------------------------------------------------------------------------------//
void Setting::Setting_Legend( TLegend *leg, int Font, int Al, int Col, double Size, int TranspFlag ){
...
//---------------------------------------------------------------------------------//
void Setting::Setting_Line( TCurlyLine *lin, int LCol, int LWid, int LSty, double CulAmp, double CulWL ){
    lin->SetLineColor(LCol);
    lin->SetLineWidth(LWid);
    lin->SetLineStyle(LSty);
...
//---------------------------------------------------------------------------------//
void Setting::Setting_Arrow( TArrow *arr, int LCol, int LWid, int LSty ){
    arr->SetLineColor(LCol);
    arr->SetLineWidth(LWid);
    arr->SetLineStyle(LSty);
}

//---------------------------------------------------------------------------------//
void Setting::Setting_Arc( TArc *arc, int LCol, int LWid, int LSty, int FCol, int FSty ){
    arc->SetLineColor(LCol);
    arc->SetLineWidth(LWid);
    arc->SetLineStyle(LSty);
    arc->SetFillColor(FCol);
    arc->SetFillStyle(FSty);
}
...
//---------------------------------------------------------------------------------//
void Setting::RedrawFrame(TFrame *frame){
	gPad->Update();
	gPad->Modified(1);
...
//---------------------------------------------------------------------------------//
TString Setting::DrawOption(int Num, int Type){
	//Type:
	//0 >> Only Line
	//1 >> Only Marker
	//2 >> Line and Marker
